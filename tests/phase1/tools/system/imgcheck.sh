...
assert_text_equals "$($ROOT_DIR/build/imgcheck --plain "$WORK_DIR/sample.gif")" "$WORK_DIR/sample.gif${tab}gif${tab}ok${tab}recognized; deep validation not implemented" "imgcheck did not accept recognized GIF"
