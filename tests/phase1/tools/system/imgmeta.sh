...
"$ROOT_DIR/build/imgmeta" strip -o "$WORK_DIR/clean-c.jpg" "$WORK_DIR/c2pa.jpg"
"$ROOT_DIR/build/imgmeta" show "$WORK_DIR/clean-c.jpg" > "$WORK_DIR/show-clean-c2pa-jpeg.out"
