...
tee_status=0
printf 'partial write\n' | "${TEST_BIN_DIR}/tee" -i "$WORK_DIR/partial.txt" "$WORK_DIR/missing/fail.txt" > "$WORK_DIR/partial.out" 2> "$WORK_DIR/partial.err" || tee_status=$?
