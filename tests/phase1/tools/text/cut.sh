...
"$ROOT_DIR/build/cut" -c "$many_ranges" "$WORK_DIR/many_ranges.txt" > "$WORK_DIR/many_ranges.out"
...
"$ROOT_DIR/build/cut" -c 9001 "$WORK_DIR/long_line.txt" > "$WORK_DIR/long_line.out"
...
"$ROOT_DIR/build/cut" -z -d ':' -f 2 "$WORK_DIR/nul_fields.txt" > "$WORK_DIR/nul_fields.out"
...
"$ROOT_DIR/build/cut" -b 1 "$WORK_DIR/byte_mode.txt" > "$WORK_DIR/byte_mode.out"
