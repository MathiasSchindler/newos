...
"$ROOT_DIR/build/comm" "$WORK_DIR/comm_left.txt" "$WORK_DIR/comm_right.txt" > "$WORK_DIR/comm.out"
...
"$ROOT_DIR/build/comm" -12 "$WORK_DIR/comm_left.txt" "$WORK_DIR/comm_right.txt" > "$WORK_DIR/comm_common.out"
