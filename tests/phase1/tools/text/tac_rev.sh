...
"$ROOT_DIR/build/rev" "$WORK_DIR/combining_rev.txt" > "$WORK_DIR/combining_rev.out"
...
"$ROOT_DIR/build/rev" "$WORK_DIR/escape_rev.txt" > "$WORK_DIR/escape_rev.out"
...
"$ROOT_DIR/build/rev" -0 "$WORK_DIR/nul_rev.txt" > "$WORK_DIR/nul_rev.out"
...
"$ROOT_DIR/build/rev" "$WORK_DIR/long_rev.txt" > "$WORK_DIR/long_rev.out"
