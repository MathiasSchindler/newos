...
"${TEST_BIN_DIR}/ncc" -S --target linux-x86_64 "$WORK_DIR/sample.c" -o "$WORK_DIR/sample_linux.s"
...
"${TEST_BIN_DIR}/ncc" -S --target linux-x86_64 "$WORK_DIR/zero_branch.c" -o "$WORK_DIR/zero_branch_linux.s"
...
"${TEST_BIN_DIR}/ncc" -S --target linux-x86_64 "$WORK_DIR/cached_params.c" -o "$WORK_DIR/cached_params_linux.s"
...
"${TEST_BIN_DIR}/ncc" -S --target linux-x86_64 "$WORK_DIR/mutated_param.c" -o "$WORK_DIR/mutated_param_linux.s"
...
"${TEST_BIN_DIR}/ncc" -S --target linux-x86_64 "$WORK_DIR/cached_local.c" -o "$WORK_DIR/cached_local_linux.s"
...
"${TEST_BIN_DIR}/ncc" -S --target linux-x86_64 "$WORK_DIR/cached_mutable_local.c" -o "$WORK_DIR/cached_mutable_local_linux.s"
...
"${TEST_BIN_DIR}/ncc" -S --target linux-x86_64 "$WORK_DIR/cached_index.c" -o "$WORK_DIR/cached_index_linux.s"
...
"${TEST_BIN_DIR}/ncc" -S --target linux-x86_64 "$WORK_DIR/direct_branch_compare.c" -o "$WORK_DIR/direct_branch_compare_linux.s"
...
"${TEST_BIN_DIR}/ncc" -S --target linux-x86_64 "$WORK_DIR/block_scratch_cache.c" -o "$WORK_DIR/block_scratch_cache_linux.s"
...
"${TEST_BIN_DIR}/ncc" -S --target linux-x86_64 "$WORK_DIR/block_branch_seed.c" -o "$WORK_DIR/block_branch_seed_linux.s"
...
"${TEST_BIN_DIR}/ncc" -S --target linux-x86_64 "$WORK_DIR/mutated_local.c" -o "$WORK_DIR/mutated_local_linux.s"
...
"${TEST_BIN_DIR}/ncc" -S --target linux-x86_64 "$WORK_DIR/register_call_args.c" -o "$WORK_DIR/register_call_args_linux.s"
...
"${TEST_BIN_DIR}/ncc" -S --target macos-aarch64 "$WORK_DIR/sample.c" -o "$WORK_DIR/sample_macos.s"
...
assert_command_succeeds "${TEST_BIN_DIR}/ncc" -Wno-pedantic -S --target macos-aarch64 "$WORK_DIR/sample.c" -o "$WORK_DIR/sample_warn_macos.s"
"${TEST_BIN_DIR}/ncc" -S --target macos-aarch64 -ffunction-sections -fdata-sections "$WORK_DIR/sample.c" -o "$WORK_DIR/sample_macos_sections.s"
...
if [ "$(uname -s)" = "Linux" ]; then
    "${TEST_BIN_DIR}/ncc" -c --target linux-x86_64 "$WORK_DIR/sample.c" -o "$WORK_DIR/sample_linux.o"
    "${TEST_BIN_DIR}/hexdump" "$WORK_DIR/sample_linux.o" > "$WORK_DIR/sample_linux_hex.out"
    assert_file_contains "$WORK_DIR/sample_linux_hex.out" '7f 45 4c 46' "compiler object writer did not emit ELF magic"

    "${TEST_BIN_DIR}/ncc" -S --target linux-x86_64 -ffunction-sections -fdata-sections "$WORK_DIR/sample.c" -o "$WORK_DIR/sample_linux_sections.s"
    ...
    assert_command_succeeds "${TEST_BIN_DIR}/ncc" --target linux-x86_64 -ffunction-sections -fdata-sections -Wl,--gc-sections "$WORK_DIR/sample.c" -o "$WORK_DIR/sample_gc_bin"
...
EOF
    ...
    "${TEST_BIN_DIR}/ncc" -S --target linux-x86_64 -ffunction-sections -fdata-sections "$WORK_DIR/bss_globals.c" -o "$WORK_DIR/bss_globals_linux.s"
...
"${TEST_BIN_DIR}/ncc" -c --target macos-aarch64 "$WORK_DIR/sample.c" -o "$WORK_DIR/sample_macos.o"
"${TEST_BIN_DIR}/hexdump" "$WORK_DIR/sample_macos.o" > "$WORK_DIR/sample_macos_hex.out"
...
"${TEST_BIN_DIR}/ncc" -S --target linux-x86_64 "$WORK_DIR/bool_value.c" -o "$WORK_DIR/bool_value_linux.s"
...
"${TEST_BIN_DIR}/ncc" -S --target linux-x86_64 "$WORK_DIR/direct_branch.c" -o "$WORK_DIR/direct_branch_linux.s"
...
"${TEST_BIN_DIR}/ncc" -S --target linux-x86_64 "$WORK_DIR/pointer_scale.c" -o "$WORK_DIR/pointer_scale_linux.s"
...
"${TEST_BIN_DIR}/ncc" -S --target macos-aarch64 "$WORK_DIR/pointer_scale.c" -o "$WORK_DIR/pointer_scale_macos.s"
...
"${TEST_BIN_DIR}/ncc" --dump-ir --target linux-x86_64 "$WORK_DIR/same_value_compare.c" > "$WORK_DIR/same_value_compare_linux.ir"
...
"${TEST_BIN_DIR}/ncc" --dump-ir --target macos-aarch64 "$WORK_DIR/same_value_compare.c" > "$WORK_DIR/same_value_compare_macos.ir"
...
"${TEST_BIN_DIR}/ncc" --dump-ir --target linux-x86_64 "$WORK_DIR/same_arm_conditional.c" > "$WORK_DIR/same_arm_conditional_linux.ir"
...
"${TEST_BIN_DIR}/ncc" --dump-ir --target macos-aarch64 "$WORK_DIR/same_arm_conditional.c" > "$WORK_DIR/same_arm_conditional_macos.ir"
...
"${TEST_BIN_DIR}/ncc" --dump-ir --target macos-aarch64 "$WORK_DIR/side_effect_conditional.c" > "$WORK_DIR/side_effect_conditional.ir"
...
"${TEST_BIN_DIR}/ncc" -c --target macos-aarch64 "$WORK_DIR/flow.c" -o "$WORK_DIR/flow_macos.o"
"${TEST_BIN_DIR}/hexdump" "$WORK_DIR/flow_macos.o" > "$WORK_DIR/flow_macos_hex.out"
...
"${TEST_BIN_DIR}/ncc" -S --target macos-aarch64 "$WORK_DIR/backend_expr.c" -o "$WORK_DIR/backend_expr_macos.s"
...
assert_command_succeeds "${TEST_BIN_DIR}/ncc" -S --target macos-aarch64 "$WORK_DIR/call_index_expr.c" -o "$WORK_DIR/call_index_expr_macos.s"
...
assert_command_succeeds "${TEST_BIN_DIR}/ncc" -S --target macos-aarch64 "$WORK_DIR/termios_mask.c" -o "$WORK_DIR/termios_mask_macos.s"
...
assert_command_succeeds "${TEST_BIN_DIR}/ncc" -S --target macos-aarch64 "$WORK_DIR/prefix_member_incdec.c" -o "$WORK_DIR/prefix_member_incdec_macos.s"
...
"${TEST_BIN_DIR}/ncc" -S --target macos-aarch64 "$WORK_DIR/extern_data.c" -o "$WORK_DIR/extern_data_macos.s"
...
assert_command_succeeds "${TEST_BIN_DIR}/ncc" -c --target macos-aarch64 "$WORK_DIR/long_expr.c" -o "$WORK_DIR/long_expr_macos.o"

"${TEST_BIN_DIR}/ncc" -S --target macos-aarch64 "$ROOT_DIR/src/tools/pwd.c" -o "$WORK_DIR/pwd_repo.s"
"${TEST_BIN_DIR}/ncc" -S --target macos-aarch64 "$ROOT_DIR/src/tools/echo.c" -o "$WORK_DIR/echo_repo.s"
"${TEST_BIN_DIR}/ncc" -S --target macos-aarch64 "$ROOT_DIR/src/tools/basename.c" -o "$WORK_DIR/basename_repo.s"

if [ "$(uname -s)" = "Linux" ]; then
    assert_command_succeeds "${TEST_BIN_DIR}/ncc" -c --target linux-x86_64 "$ROOT_DIR/src/shared/runtime/unicode.c" -o "$WORK_DIR/unicode_repo.o"
    "${TEST_BIN_DIR}/hexdump" "$WORK_DIR/unicode_repo.o" > "$WORK_DIR/unicode_repo_hex.out"
