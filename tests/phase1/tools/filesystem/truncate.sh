...
printf 'truncate\n' > "$WORK_DIR/target.txt"
assert_command_succeeds "${TEST_BIN_DIR}/truncate" -s 5 "$WORK_DIR/target.txt"
...
assert_command_succeeds "${TEST_BIN_DIR}/truncate" -o -s 1 "$WORK_DIR/target.txt"
...
assert_command_succeeds "${TEST_BIN_DIR}/truncate" -c -s 10 "$WORK_DIR/missing.txt"
