...
assert_command_succeeds "${TEST_BIN_DIR}/mv" "$WORK_DIR/src/a.txt" "$WORK_DIR/src/b.txt" "$WORK_DIR/dest"
...
if "${TEST_BIN_DIR}/mv" "$WORK_DIR/self_guard" "$WORK_DIR/self_guard/child" >/dev/null 2>&1; then
...
assert_command_succeeds "${TEST_BIN_DIR}/mv" -u "$WORK_DIR/update_src.txt" "$WORK_DIR/update_dest.txt"
...
printf 'fresh-source\n' > "$WORK_DIR/update_src.txt"
assert_command_succeeds "${TEST_BIN_DIR}/touch" -d @3000000000 "$WORK_DIR/update_src.txt"
assert_command_succeeds "${TEST_BIN_DIR}/mv" -u "$WORK_DIR/update_src.txt" "$WORK_DIR/update_dest.txt"
