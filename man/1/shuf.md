...
- input records are retained in memory, so maximum input size depends on available memory
...
- no weighted sampling or stable seeding compatibility with GNU coreutils is implemented
