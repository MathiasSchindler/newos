...
$mockSource = Join-Path $PSScriptRoot "../../src/shared/tests/qnn_mock.c"
...
try {
    ...
    & $compilerPath @artifactTestFlags `
        experimental/snapdragon/src/apps/whisper/tests/whisper_artifact_test.c `
    ...
    & $compilerPath @artifactTestFlags `
        ...
        experimental/snapdragon/src/apps/whisper/tests/whisper_context_test.c `
        experimental/snapdragon/src/apps/whisper/whisper_artifact.c `
        experimental/snapdragon/src/apps/whisper/whisper_model.c `
    ...
    & $compilerPath @artifactTestFlags "-DWHISPER_DECODER_TEST_ALLOCATOR" `
        experimental/snapdragon/src/apps/whisper/tests/whisper_decoder_cleanup_test.c `
        experimental/snapdragon/src/apps/whisper/whisper_decoder.c `
        experimental/snapdragon/src/apps/whisper/whisper_artifact.c `
        experimental/snapdragon/src/apps/whisper/whisper_model.c `
        experimental/snapdragon/src/apps/whisper/whisper_frontend.c `
