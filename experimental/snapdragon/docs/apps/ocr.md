...
- Tracked source catalog: `tools/ocr/glm-ocr-model.json`.
...
Implemented tool-private C in `src/apps/ocr/ocr_tokenizer.{h,c}`:
...
```powershell
.\experimental\snapdragon\build\calibration-venv\Scripts\python.exe -B experimental/snapdragon/tools/ocr/export-glm-ocr.py --export-tokenizer
.\experimental\snapdragon\build\gemma-oracle-x64\python.exe -B experimental/snapdragon/tools/ocr/export-glm-ocr.py --wrapper-check
```
...
The tool-private `src/apps/ocr/ocr_image.{h,c}` now implements the CPU-side
...
```powershell
.\experimental\snapdragon\build\gemma-oracle-x64\python.exe -B experimental/snapdragon/tools/ocr/export-glm-ocr.py --export-images
```
...
`src/apps/ocr/ocr_htp.c` builds independent FP16 QNN graphs using the shared ABI,
...
```powershell
.\experimental\snapdragon\build\gemma-oracle-x64\python.exe -B experimental/snapdragon/tools/ocr/export-glm-ocr.py --export-htp
...
```powershell
.\experimental\snapdragon\build\gemma-oracle-x64\python.exe -B experimental/snapdragon/tools/ocr/export-glm-ocr.py --audit-precision
.\experimental\snapdragon\build\gemma-oracle-x64\python.exe -B experimental/snapdragon/tools/ocr/export-glm-ocr.py --export-learned-htp
...
```powershell
.\experimental\snapdragon\build\gemma-oracle-x64\python.exe -B experimental/snapdragon/tools/ocr/export-glm-ocr.py --analyze-attention-failures
```
...
```powershell
.\experimental\snapdragon\build\gemma-oracle-x64\python.exe -B experimental/snapdragon/tools/ocr/export-glm-ocr.py --export-vision-attention --attention-case all
```
...
```powershell
.\experimental\snapdragon\build\gemma-oracle-x64\python.exe -B experimental/snapdragon/tools/ocr/export-glm-ocr.py --export-vision-block --attention-case all
...
```powershell
.\experimental\snapdragon\build\gemma-oracle-x64\python.exe -B experimental/snapdragon/tools/ocr/export-glm-ocr.py --export-vision-block --attention-case examples --vision-block-output experimental/snapdragon/models/glm-ocr-examples-v1
...
```powershell
.\experimental\snapdragon\build\gemma-oracle-x64\python.exe -B experimental/snapdragon/tools/ocr/export-glm-ocr.py --export-vision-encoder
.\experimental\snapdragon\tools\build-ocr.ps1 -TestVision -Test -BuildDir experimental/snapdragon/build/ocr-vision
.\experimental\snapdragon\build\gemma-oracle-x64\python.exe -B experimental/snapdragon/tools/ocr/export-glm-ocr.py --analyze-vision-encoder
```
...
```powershell
.\experimental\snapdragon\build\gemma-oracle-x64\python.exe -B experimental/snapdragon/tools/ocr/export-glm-ocr.py --export-text-decoder
...
.\experimental\snapdragon\build\gemma-oracle-x64\python.exe -B experimental/snapdragon/tools/ocr/export-glm-ocr.py --analyze-text-prefill
```
...
```powershell
.\experimental\snapdragon\build\gemma-oracle-x64\python.exe -B experimental/snapdragon/tools/ocr/export-glm-ocr.py --export-generation
...
.\experimental\snapdragon\build\gemma-oracle-x64\python.exe -B experimental/snapdragon/tools/ocr/export-glm-ocr.py --analyze-generation --generation-build experimental/snapdragon/build/ocr-retained-full
.\experimental\snapdragon\build\gemma-oracle-x64\python.exe -B experimental/snapdragon/tools/ocr/export-glm-ocr.py --reference-generation --generation-build experimental/snapdragon/build/ocr-retained-full
```
...
```powershell
.\experimental\snapdragon\build\gemma-oracle-x64\python.exe -B experimental/snapdragon/tools/ocr/export-glm-ocr.py --export-vision-encoder --large-images --vision-output experimental/snapdragon/models/glm-ocr-vision-v2
...
`src/apps/ocr/ocr_gui.c` is a native Win32 front end in the same visual style
