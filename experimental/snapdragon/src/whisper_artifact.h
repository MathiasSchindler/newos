...
typedef enum WhisperArtifactPayloadType {
    ...
    WHISPER_ARTIFACT_PAYLOAD_DECODER_MLP_WEIGHTS = 7,
    WHISPER_ARTIFACT_PAYLOAD_DECODER_LOGITS_WEIGHTS = 8,
    WHISPER_ARTIFACT_PAYLOAD_DECODER_SELF_ATTENTION_WEIGHTS = 9
