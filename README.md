...
default. Explicit symbol order files and weighted profiles generated by
`profiler --write-call-graph-profile` can override hot function placement for
measured workloads; packed `--tiny` output is an explicit size profile. It honors
