...
int run_clang_lto_prelink_macho64_aarch64(const char *const *paths, size_t count, const char *entry_symbol, const char *lto_cc, const char *out_path, int dead_strip, char *error_out, size_t error_size);
