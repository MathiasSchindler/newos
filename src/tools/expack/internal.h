...
#define EXPACK_ZERO_ORIGINAL_SIZE_OFFSET 273U
#define EXPACK_ZERO_PAYLOAD_SIZE_OFFSET 281U
#define EXPACK_BYTE_RUN_ORIGINAL_SIZE_OFFSET 285U
#define EXPACK_BYTE_RUN_PAYLOAD_SIZE_OFFSET 293U
