...
unsigned int rt_unicode_display_width(unsigned int codepoint) {
    static const UnicodeRange zero_width_ranges[] = {
    ...
    static const UnicodeRange wide_ranges[] = {
    ...
    if (codepoint_in_ranges(codepoint, zero_width_ranges, sizeof(zero_width_ranges) / sizeof(zero_width_ranges[0]))) {
        return 0U;
    }
    if (codepoint_in_ranges(codepoint, wide_ranges, sizeof(wide_ranges) / sizeof(wide_ranges[0]))) {
        return 2U;
    }
