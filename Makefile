...
PGP_SOURCES := $(shell grep -oE '"src/shared/(pgp|crypto/(aes128|aes128_gcm|sha1|sha256|sha512|hmac_sha256|hkdf_sha256|crypto_util|curve25519|ed25519)|compression/zlib)\.c"' src/compiler/source_manifest.h | tr -d '"' | sort -u)
