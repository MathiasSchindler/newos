...
WINDOWS_FREESTANDING_PDF_TOOLS := pdfinfo pdfjoin pdfsplit pdfinfoedit
...
MACOS_FREESTANDING_PDF_TOOLS := pdfinfo pdfjoin pdfsplit pdfinfoedit
...
PDF_TOOLS := pdfinfo pdfjoin pdfsplit pdfinfoedit
